...
class LPSolver(object):
    ...
    """
    def __init__(self, A_eq, b_eq, A_lt, b_lt, A_gt, b_gt, c_obj, maximize=True, problem_name="Mippy_problem", solver_type='SIMP',append=False):
        self.append = append
    ...
    def compile(self):
        ...
        if self.append and os.path.isfile(mippy_file):
            f = open(mippy_file,"a")
        else:       
            f = open(mippy_file,"w+")
            # max or mix problem
